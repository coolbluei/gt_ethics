...
do
  ...
  The following options are available:
    ...
    -u      The database user
    -h      The database host; defaults to localhost
...
yes | composer create-project --repository-url=packages.json --remove-vcs --stability dev gt/gt_installer $PROJECTPATH
if [ ! "$?" = "0" ]; then
